    ...
    <div>
            ...
            <Row gutter={30}>
              <Col span={12}>
                <Form.Item name="package">
                  ...
                  >
                    ...
                    <Select.Option>bbb</Select.Option>
              ...
              <Col span={12}>
                <Form.Item name="choose_treatment">
                  <Select
                    placeholder="Эмчилгээ сонгох"
                    name="choose_treatment"
                    style={{ width: "100%" }}
                    className="input"
                    bordered={false}
                  >
            ...
            <Row gutter={30}>
              <Col span={12} style={{ marginTop: "30px" }}>
                <Form.Item name="planned_treatment">
                  <Select
                    placeholder="Төлөвлөгөөт эмчилгээ"
      ...
      >
        <Row justify="end">
          <Col>
            {servicebool ? (
              <Button className="save_button">Хадгалах</Button>
            ) : (
              <Button
                onClick={() => setServiceBool(!servicebool)}
                className="save_button"
              >
                Үйлчилгээ авах
              </Button>
